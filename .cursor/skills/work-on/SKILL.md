...
4. Identify whether the change affects public API, Selenium behavior, tests, packaging, or release flow.
...
3. Keep default tests deterministic; mark live-site checks as `integration`.
